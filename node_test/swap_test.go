...
func TestSwapFund(t *testing.T) {
	...
	t.Log("Direct-fund objective complete")
	...
	ledgerChannelState, _ := nodeA.GetSignedState(ledgerResponse.ChannelId)

	marshalledState, _ := ledgerChannelState.MarshalJSON()
